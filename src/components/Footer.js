  ...
  return (
    ...
    >
      <Stack direction={"column"} justifyContent={{ lg: "center", xs: "flex-start" }} alignItems={{ lg: "center", xs: "flex-start" }} spacing={5} >
        ...
        <Typography color="white" fontSize={{ lg: 60, xs: 20 }} fontWeight={"medium"}>
          Next up - Travel for Five Generation
        </Typography>
        <Stack direction={{ lg: "row", xs: "column" }} spacing={2} >
          <Link href="/about" passHref>
            <Typography fontSize={{ lg: 20, xs: 14 }} fontWeight={"bold"} sx={{ cursor: "pointer" }} color="white">
              About Us
            </Typography>
          </Link>
        ...
        <Stack direction={{ lg: "row", xs: "column" }} spacing={{ lg: 5, xs: 2 }} >
          <Typography fontSize={{ lg: 25, xs: 14 }} fontWeight={"bold"} color="white">Mail: info@uuro.com</Typography>
          <Typography fontSize={{ lg: 25, xs: 14 }} fontWeight={"bold"} color="white">Phone: +880 1700000000</Typography>
